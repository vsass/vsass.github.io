...
1. Required to download the AFINN and nrc datasets
...
library(colorspace)
library(ggridges) 
season_words <- left_join(season_words, total_words) |> filter(season < 15)
...
## {background-image="images/mister_rogers.jpg" background-size="cover" auto-animate=true}
