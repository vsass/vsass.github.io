...
[29 April 2026]{.custom-subtitle2}
...
%%| fig-align: center
flowchart LR
    id1((Variable))==>A(["1. Contain TRUE/FALSE/NA?"])==>id2{{Logical}}
    id1((Variable))==>B(["2. Contain only numbers"])==>id3{{Number}}
    id1((Variable))==>C(["3. Match ISO8601 standard?"])==>id4{{Date/Date-time}}
